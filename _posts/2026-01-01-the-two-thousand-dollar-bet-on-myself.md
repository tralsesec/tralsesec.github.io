---
layout: post
title: "The $2000 Bet: Why I Double Down on Offensive Operations"
date: 2026-01-01 20:02:00 +0100
categories: [research, training, mindset, career]
tags: [CPTS, CAPE, CWEE, HackTheBox, Certifications, Mindset, Career]
images:
  - url: "/assets/img/2026-01-01-gold-annual.png"
    ref: "GOLD_ANNUAL"
  - url: "/assets/img/2026-01-01-paypal-payment.png"
    ref: "PAYPAL_PAYMENT"
---
...
So I decided to force the issue.
By funding my own training stack, I am collapsing the time gap between potential and proof. I am not asking to be trained into expertise later—I am building it upfront and letting the title lag behind.
...
Gold unlocks advanced material that most candidates never touch until _after_ they are certified—if ever. That asymmetry enables a deliberate strategy:

I train **above** the target.

- The _goal_ is CPTS (Tier II).
    
- The _training environment_ is **CAPE** (Active Directory tradecraft) and **CWEE** (white/blackbox web exploitation).
...
I am not waiting for a "Senior" title to start training like one.
I am shifting gears from speedrunning theory to deep, operational tradecraft.
